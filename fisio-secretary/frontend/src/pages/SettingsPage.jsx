...
import { Wifi, WifiOff, Loader2, Smartphone, RotateCcw, AlertCircle, X, RefreshCw, Trash2, Radio, Plus, Image as ImageIcon, Play, ChevronDown, Wand2, CheckCircle2, Search, ChevronUp, Copy, BookOpen, Sparkles, Lock, Eye, EyeOff } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {/* Card trocar senha — sempre visível, independe da instância do WhatsApp */}
      <ChangePasswordCard />
